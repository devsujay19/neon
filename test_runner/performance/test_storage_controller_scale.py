...
def test_storage_controller_many_tenants(
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=api_concurrency) as executor:
        ...
        # FIXME: the controller will sometimes schedule shards in a way that
        # the optimization logic immediately chooses to move: get these migrations out of the
        # way first before proceeding
